...
namespace UserRegisration_MVC.Models
{
    using System;
    ...
    public partial class UserRegistration_MVCEntities : DbContext
    {
        public UserRegistration_MVCEntities()
            : base("name=UserRegistration_MVCEntities")
        {
        }
